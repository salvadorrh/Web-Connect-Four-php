<?php
// torture.php - torture a Connect Four web service by performing
// various tests, esp. error handling.
// Requires PHP version 5.3.3 or higher

// set to the base address (URL) of your C4 web service
$home = "https://cssrvlab01.utep.edu/classes/cs3360/sroblesher1/";
// $home = "http://www.cs.utep.edu/cheon/cs3360/project/c4/";
// $home = "http://localhost:63342/ConnectFourService/src/";
// $home = "C:\\Users\\salva\\OneDrive\\Documents\\UTEP\\5 Fifth Semester\\Design and Impl. Prog. Lang\\php\\ConnectFourService\\src\\";
// $home = 'C:/Users/salva/OneDrive/Documents/UTEP/5 Fifth Semester/Design and Impl. Prog. Lang/php/ConnectFourService/src/';
// $home = "C:\Users\salva\OneDrive\Documents\UTEP\5 Fifth Semester\Design and Impl. Prog. Lang\php\ConnectFourService\src";
// $home = str_replace("\5", '\5', $home);
// $home = str_replace("\t", '\t', $home);

// $home = dirname(dirname(__FILE__));
//$home = str_replace("ConnectFourService/src", "", $home);
...
function visitNew($strategy = null) {
    ...
    $hello = $home . "/new/index.php" . $query;
...
function visitPlay($pid = null, $move = null) {
    ...
    print_r("\nPLAY\n");
    print_r(@file_get_contents($home . "/play/index.php" . $query));
